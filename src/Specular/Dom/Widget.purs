...
class (MonadDomBuilder m, MonadFRP m, MonadReplace m, MonadDetach m) <= MonadWidget m
instance monadWidget :: (MonadDomBuilder m, MonadFRP m, MonadReplace m, MonadDetach m) => MonadWidget m
