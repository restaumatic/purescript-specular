...
import Specular.Dom.Browser (Attrs, Event, EventType, Namespace, Node, TagName, addEventListener, addEventListenerImpl, appendChild, appendChildImpl, appendRawHtml, appendRawHtmlImpl, createDocumentFragment, createDocumentFragmentImpl, createElement, createElementImpl, createElementNS, createElementNSImpl, createTextNode, createTextNodeImpl, innerHTML, insertBefore, insertBeforeImpl, moveAllBetweenInclusive, moveAllBetweenInclusiveImpl, parentNode, parentNodeImpl, preventDefault, removeAllBetween, removeAllBetweenImpl, removeAttributes, removeAttributesImpl, setAttributeImpl, setAttributes, setText, setTextImpl, (:=)) as X
